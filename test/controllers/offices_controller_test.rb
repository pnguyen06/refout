...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { bank_id: @office.bank_id, city: @office.city, description: @office.description, name: @office.name, phone: @office.phone, street: @office.street }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { bank_id: @office.bank_id, city: @office.city, description: @office.description, name: @office.name, phone: @office.phone, street: @office.street }
    assert_redirected_to office_path(assigns(:office))
  end
